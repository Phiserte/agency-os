...
export default function MarketingDashboard({
  ...
  // Combined Click Outside handler for mobile sidebar and profile dropdown
  useEffect(() => {
    const handleClickOutside = (e: MouseEvent) => {
      if (isMobile && isMobileSidebarOpen && sidebarRef.current && !sidebarRef.current.contains(e.target as Node)) {
  ...
  }, [isMobileSidebarOpen, isMobile, isProfileOpen])
          ...
          <div ref={profileRef} style={{ position: "relative" }}>
            <div 
              ...
              style={{
                ...
                border: `1px solid ${isProfileOpen ? P.purple : P.border}`, 
            ...
            {isProfileOpen && (
              <div style={{
                ...
                width: 240, background: P.card, borderRadius: 12,
                ...
                <div style={{ padding: "16px 16px 12px", borderBottom: `1px solid ${P.border}`, background: "#FAFAFB" }}>
                  <div style={{ display: "flex", alignItems: "center", gap: 10 }}>
                    <Avatar name={user.name} size={36} />
                    <div style={{ minWidth: 0 }}>
                      <p style={{ margin: 0, fontSize: 13, fontWeight: 600, color: P.text, overflow: "hidden", textOverflow: "ellipsis", whiteSpace: "nowrap" }}>
                        {user.name}
                      </p>
                      <p style={{ margin: "2px 0 0", fontSize: 11, color: P.textSub, overflow: "hidden", textOverflow: "ellipsis", whiteSpace: "nowrap" }}>
                        {user.email}
                      </p>
                    </div>
                  </div>
                ...
                <div style={{ padding: 6 }}>
                  <div style={{
                    ...
                    color: P.textSub, fontWeight: 500
                  }}>
                    <Shield size={14} color={P.textMute} />
                    <span>Role: <strong style={{ color: P.purpleText, fontWeight: 600 }}>{user.role}</strong></span>
                  </div>

                  <hr style={{ border: "none", borderTop: `1px solid ${P.border}`, margin: "4px 0" }} />

                  <button 
                    onClick={() => {
                      setIsProfileOpen(false)
                      // Handle custom logout navigation method safely here
                    }}
                    style={{
                      width: "100%", border: "none", background: "transparent",
                      display: "flex", alignItems: "center", gap: 8,
                      padding: "8px 10px", borderRadius: 8, fontSize: 12,
                      color: P.red, fontWeight: 500, textAlign: "left",
                      cursor: "pointer", transition: "background 0.1s ease"
                    }}
                    onMouseEnter={(e) => e.currentTarget.style.background = P.redDim}
                    onMouseLeave={(e) => e.currentTarget.style.background = "transparent"}
                  >
                    <LogOut size={14} color={P.red} />
                    <span>Sign Out</span>
                  </button>
                </div>
              </div>
        ...
        <div style={{ flex: 1, overflowY: "auto", padding: isMobile ? "16px 14px 32px" : "24px 28px 40px" }}>
          ...
          <div style={{
            ...
            <div style={{
              ...
              <div>
                <span style={{ fontSize: 14, fontWeight: 700, color: P.text }}>Marketing Tasks</span>
                <span style={{
